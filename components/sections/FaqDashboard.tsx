...
const mockFaqs: FaqItem[] = [
  {
    ...
    name: "أحمد محمد",
    sector: "sports",
    question: "ما هي مواعيد الملاعب الرياضية؟",
    status: "pending",
    date: "2025-03-01",
  },
  {
    id: "2",
    sector: "health",
    question: "كيف يمكنني حجز موعد في المستشفى؟",
    answer: "يمكنك التواصل مع المستشفى مباشرة على الرقم المدرج",
    status: "answered",
    date: "2025-03-05",
  },
  {
    ...
    name: "خالد عمر",
    sector: "education",
    question: "ما هي شروط التسجيل في المدارس الحكومية؟",
    status: "pending",
    date: "2025-03-10",
  },
]
...
export default function FaqDashboard() {
  ...
  const sectorName = (sector: string) => {
    const map: Record<string, string> = {
      sports: locale === "ar" ? "رياضة" : "Sports",
      health: locale === "ar" ? "صحة" : "Health",
      education: locale === "ar" ? "تعليم" : "Education",
    }
